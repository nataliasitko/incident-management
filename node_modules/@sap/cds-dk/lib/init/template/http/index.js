...
module.exports = class HttpTemplate extends require('../../plugin') {
  ...
  async #getHostnameAndAuth(service, csn) {
    ...
    if (!this.approuterAuth) {
      ...
      this.hostname = `https://${env.application_env_json.VCAP_APPLICATION.application_uris[0]}`
      ...
      this.approuterAuth = `x-approuter-authorization: bearer ${access_token}`
    }
    return [this.hostname, this.approuterAuth]
  }
